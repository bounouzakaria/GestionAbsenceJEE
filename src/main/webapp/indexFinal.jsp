  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="/indexTables">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="pages/billing.html">
            ...
            <span class="nav-link-text ms-1">Etudiant</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="pages/virtual-reality.html">
            ...
            <span class="nav-link-text ms-1">Filliere</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="pages/sign-in.html">
            ...
            <span class="nav-link-text ms-1">Seance</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="authFinal.jsp">Logout</a>
            </li>
              ...
              <div class="table-responsive">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <!--Code de colonnes-->
                      <th class="text-center text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">ID</th>
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7">Nom</th>
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Prenom</th>
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Telephone</th>
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Email</th>
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7 ps-2">Password</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-0"><%=rs.getString(1)%></h4>
                          </div>
                      ...
                      <td>
                        <div class="text-center d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-0 "><%=rs.getString(2)%></h4>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-0"><%=rs.getString(3)%></h4>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-0"><%=rs.getString(4)%></h4>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-0 "><%=rs1.getString(2)%></h4>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h4 class="mb-0"><%=rs1.getString(3)%></h4>
                          </div>
                        </div>
                      </td>
					  <%      	 
                      ...
                      <td>
                        <div class="d-flex justify-content-center px-1 py-1">
                            <button class="btn btn-light"><a href="Delete?user_id=<%=rs.getString(5)%>&id_prof=<%= rs.getString(1)%>">Supprimer</a></button>
                            <button class="btn btn-general"><a href="Update?id_prof=<%=rs.getString(1) %>">modifier</a></button>
                        </div>
                      </td>
					</tr>	        		 
						<%
